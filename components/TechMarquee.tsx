...
export default function TechMarquee() {
  return (
    ...
    <div className="mx-auto max-w-content relative mt-4 z-10 backdrop-blur-sm">
      <div className="absolute z-10 left-0 right-0 mt-4 overflow-hidden border-y border-line py-4 bg-transparent">
